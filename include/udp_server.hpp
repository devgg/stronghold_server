...
namespace communication {
	...
	class udp_server: public gateway {
	...
	public:
		...
		virtual void unicast(const boost::asio::ip::udp::endpoint& endpoint, const boost::asio::streambuf& data) override;
		virtual void multicast(const std::vector<boost::asio::ip::udp::endpoint>& endpoints, const boost::asio::streambuf& data) override;
