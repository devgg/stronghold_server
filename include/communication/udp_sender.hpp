...
namespace communication {
	...
	class udp_sender {
		...
		void handle_unicast(boost::asio::streambuf* streambuf, const boost::system::error_code& error, std::size_t bytes_transferred);
		void handle_multicast(boost::asio::streambuf* streambuf, std::atomic<size_t>* counter, size_t num_endpoints, const boost::system::error_code& error, std::size_t bytes_transferred);
